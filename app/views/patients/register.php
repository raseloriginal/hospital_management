...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h2 class="text-xl font-bold text-slate-800 uppercase tracking-tight">Patient Registration Entry</h2>
        <p class="text-[10px] text-slate-500 font-bold uppercase tracking-widest">New Resource Addition: Medical Record Row</p>
    </div>
...
<div class="bg-white border border-slate-300 shadow-sm overflow-hidden max-w-4xl">
    <div class="p-3 border-b border-slate-300 bg-[#217346] text-white">
        <h3 class="text-[11px] font-black uppercase tracking-widest">Administrative Bio-Data Form</h3>
    </div>
    <div class="p-6">
        <form action="<?php echo URLROOT; ?>/patients/register" method="post" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                <!-- Name -->
                <div class="flex flex-col">
                    <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Row Header: FULL NAME *</label>
                ...
                <!-- Phone -->
                <div class="flex flex-col">
                    <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Column Label: CONTACT NO *</label>
                ...
                <!-- DOB -->
                <div class="flex flex-col">
                    <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Attribute: DATE OF BIRTH *</label>
                ...
                <!-- Gender -->
                <div class="flex flex-col">
                    <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Variable: GENDER *</label>
                ...
                <!-- Blood Group -->
                <div class="flex flex-col">
                    <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Biological Data: BLOOD GROUP</label>
                ...
                <!-- Emergency Contact -->
                <div class="flex flex-col">
                    <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Alternate Value: EMERGENCY CONTACT</label>
            ...
            <div class="pt-4 border-t border-slate-200">
                <button type="submit" class="bg-[#217346] hover:bg-slate-800 text-white px-8 py-2 rounded-sm font-black text-xs transition-all uppercase tracking-widest shadow-[4px_4px_0px_rgba(33,115,70,0.1)]">
                    <i class="fas fa-save mr-2"></i> COMMIT TRANSACTION
                </button>
            </div>
        </form>
    </div>
